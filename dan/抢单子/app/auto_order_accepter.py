...
class App(tk.Tk):
    ...
    def create_widgets(self):
        # ... (这部分UI创建代码与之前版本完全相同，为节省篇幅此处省略) ...
        # ... (请直接从你之前的脚本中复制 create_widgets 的全部内容到这里) ...
    ...
    def stop_automation(self):
        ...
        # 【修改】点击停止后还原窗口
        self.deiconify()
        self.attributes('-topmost', True)  # 再次确保窗口在最前
        ...
        while self.is_running:
            try:
                ...
                if is_new_order:
                    ...
                    # 【修改】接单后强制等待，给界面足够的时间刷新，避免立即又读到旧信息
                    time.sleep(3)
...
if __name__ == "__main__":
    # 如果脚本找不到tesseract，请取消下面这行的注释，并确认路径正确
